  ...
  <section id="contact" class="padd-section wow fadeInUp">
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-md-6">
          <div class="form">
            <form method="post" role="form" action="<?php echo base_url('welcome/do_registrasi') ?>">
              <div class="form-group">
                <input type="text" name="nik" class="form-control" id="name" placeholder="Nomor Induk Kependudukan" required/>
              </div>
              <div class="form-group">
                <input type="text" name="namalengkap" class="form-control" id="name" placeholder="Nama Lengkap" required>
              </div>
              <div class="form-group">
                <input type="email" class="form-control" name="email" id="email" placeholder="Email" />
              </div>
              <div class="form-group">
                <input type="text" name="notelepon" class="form-control" id="name" placeholder="Nomor Telepon" required>
              </div>
              <div class="form-group">
                <input type="password" name="password1" class="form-control" id="name" placeholder="Password" required>
              </div>
              <div class="form-group">
                <input type="password" name="password2" class="form-control" id="name" placeholder="Ulangi Password" required>
              </div>
