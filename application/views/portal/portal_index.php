...
<div class="wrapper">
  ...
  <aside class="main-sidebar elevation-4 sidebar-light-primary">
    <!-- Brand Logo -->
    <a href="<?php echo base_url('welcome/main') ?>" class="brand-link">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="<?php echo base_url('welcome/profile') ?>" class="d-block">Bambang Radwe Pusaka</a>
        </div>
      </div>

      <!-- Sidebar Menu -->
      <?php $this->load->view('portal/portal_sidebar_menu') ?>
      <!-- /.sidebar-menu -->
    </div>
    <!-- /.sidebar -->
  </aside>
